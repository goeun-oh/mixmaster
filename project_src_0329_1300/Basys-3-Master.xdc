...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {io_dht}];#Sch name = JA1
...
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {echo}];#Sch name = XA3_P
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {trig}];#Sch name = XA4_P
